...
class dovecot::sieve (
  ...
  dovecot::config::dovecotcfmulti { 'plugin':
    config_file => 'conf.d/90-sieve.conf',
    changes     => [
      "set plugin/sieve '~/.dovecot.sieve'",
      "set plugin/sieve_dir '~/sieve'",
      "set plugin/sieve_default '/var/lib/dovecot/sieve/default.sieve'",
      "set plugin/sieve_global '/var/lib/dovecot/sieve/'",
#      "set mail_plugins '\$mail_plugins sieve'",
      ],
  }
}
